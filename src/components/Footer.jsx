  ...
  return (
    <footer className="bg-[#031525]">
      ...
      >
        ...
        >
          <div>
            <h3 className={styleH3}>Shopdoc</h3>
            <p className={clsx(styleP, "max-w-[176px] mx-auto md:ml-0")}>
              High quality and trusted medical shop service
            </p>
          </div>
          <div>
            <h3 className={styleH3}>About us</h3>
            <ul className={clsx(styleP, "flex flex-col gap-2", "md:gap-4")}>
              <li className="hover:text-white/90 transition">
                <Link to={PAGES.ABOUT}>Who We Are</Link>
              </li>
              <li className="hover:text-white/90 transition">
                <Link to={PAGES.ABOUT}>Vission & Mission</Link>
              </li>
              <li className="hover:text-white/90 transition">
                <Link to={PAGES.ABOUT}>Core Values</Link>
              </li>
              <li className="hover:text-white/90 transition">
                <Link to={PAGES.ABOUT}>Quality Policy</Link>
              </li>
            </ul>
          </div>
          <div>
            <h3 className={styleH3}>FAQ</h3>
            <Link to={PAGES.ABOUT} className={styleP}>
              FAQ
            </Link>
          </div>
          <div>
            <h3 className={styleH3}>Blog</h3>
            <Link to={PAGES.ABOUT} className={styleP}>
              Blog
            </Link>
          </div>
          <div>
            <h3 className={styleH3}>Contact us</h3>
            <p className={clsx(styleP, "mb-6")}>Get in toch is easy</p>
            <p className={clsx(styleP, "mb-[14px]")}>Follow us</p>
            <nav>
              <ul
                className={clsx(
