...
const styleH3 =
  "font-medium text-xl leading-normal text-white mb-[14px] md:mb-[24px]";
const styleP = "font-normal text-base leading-normal text-white/60 ";

const Footer = () => {
  return (
    <footer className="bg-[#031525]">
      <div
        className={clsx(
          "px-[16px] ",
          "md:px-[80px]",
      ...
      >
        <div
          className={clsx(
            "grid grid-cols-1  pt-[60px] pb-[123px] gap-[20px] text-center justify-center",
            "md:grid-cols-2 gap-y-[30px] md:text-start",
            "lg:grid-cols-3",
            "xl:grid-cols-5 gap-[162px]"
          )}
        >
          <div>
            <h3 className={styleH3}>{t("Shopdoc")}</h3>
            <p className={clsx(styleP, "max-w-[176px] mx-auto md:ml-0")}>
              {t("High quality and trusted medical shop service")}
            </p>
          </div>
          <div>
            <h3 className={styleH3}>{t("About us")}</h3>
            <ul className={clsx(styleP, "flex flex-col gap-2", "md:gap-4")}>
              <li className="hover:text-white/90 transition">
                <Link to={PAGES.ABOUT}>{t("Who We Are")}</Link>
              </li>
              <li className="hover:text-white/90 transition">
                <Link to={PAGES.ABOUT}>{t("Vission & Mission")}</Link>
              </li>
              <li className="hover:text-white/90 transition">
                <Link to={PAGES.ABOUT}>{t("Core Values")}</Link>
              </li>
              <li className="hover:text-white/90 transition">
                <Link to={PAGES.ABOUT}>{t("Quality Policy")}</Link>
              </li>
            </ul>
          </div>
          <div>
            <h3 className={styleH3}>{t("FAQ")}</h3>
            <Link to={PAGES.ABOUT} className={styleP}>
              {t("FAQ")}
            </Link>
          </div>
          <div>
            <h3 className={styleH3}>{t("Blog")}</h3>
            <Link to={PAGES.ABOUT} className={styleP}>
              {t("Blog")}
            </Link>
          </div>
          <div>
            <h3 className={styleH3}>{t("Contact us")}</h3>
            <p className={clsx(styleP, "mb-6")}>{t("Get in toch is easy")}</p>
            <p className={clsx(styleP, "mb-[14px]")}>{t("Follow us")}</p>
            <nav>
              <ul
                className={clsx(
        ...
        <div
          className={clsx(
            "shadow-inset-white py-[27px] mx-[-16px]",
            "md:mx-[-80px]",
            "lg:mx-[-120px]"
          )}
        >
